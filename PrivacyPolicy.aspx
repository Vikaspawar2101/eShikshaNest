<%@ Page Title="Privacy Policy" Language="C#" MasterPageFile="~/eShikshaNest.Master" AutoEventWireup="true" CodeBehind="PrivacyPolicy.aspx.cs" Inherits="eShikshaNest.PrivacyPolicy" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <p class="text-black fw-bold fs-6">
                            <img src="Assets/Terms&Poilicies/policy.svg" height="20" width="20" alt="terms&policies" />
                            &#160;&#160;Privacy Policy</p>
                        <hr style="width: 70%" class="border border-black border-1 opacity-25">
